...
export const CreateEnfermeiroSchema = z.object({
    nome: z.string().min(3),
...
export const UpdateEnfermeiroSchema = z.object({
    nome: z.string().min(3).optional(),
    coren: z.string().regex(/^\d{6}-[A-Z]{2}$/).optional(),
    dataContratacao: z.string().date().optional(),
});

export type CreateEnfermeiroInput = z.infer<typeof CreateEnfermeiroSchema>;
export type UpdateEnfermeiroInput = z.infer<typeof UpdateEnfermeiroSchema>;